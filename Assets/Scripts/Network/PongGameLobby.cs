...
public class PongGameLobby : MonoBehaviour
{
    public const string KEY_RELAY_JOIN_CODE = "RelayJoinCode";

    public static PongGameLobby Instance { get; private set; }
    ...
    public event EventHandler<OnLobbyLostChangedEventArgs> OnLobbyListChanged;
    public class OnLobbyLostChangedEventArgs : EventArgs
    {
    ...
    {
        if (_joinedLobby == null && AuthenticationService.Instance.IsSignedIn && !_pongGameManager.IsPlayerReadyMenuActiveInHierarchy())
        {
    ...
    private async void ListLobbies()
    {
        try
        {
            ...
            OnLobbyListChanged?.Invoke(this, new OnLobbyLostChangedEventArgs {
    ...
    private async Task<Allocation> AllocateRelay()
    {
        try
        {
            Allocation allocation = await RelayService.Instance.CreateAllocationAsync(PongGameManager.MAX_PLAYER_AMOUNT - 1);
            return allocation;
        }
    ...
    public async void CreateLobby(string lobbyName, bool isPrivate)
    {
        ...
        try
        {
            _joinedLobby = await LobbyService.Instance.CreateLobbyAsync(lobbyName, PongGameManager.MAX_PLAYER_AMOUNT, new CreateLobbyOptions{ IsPrivate = isPrivate});
            ...
            _pongGameManager.SetIsMulpiplayerGame();
    ...
    public async void QuickJoin()
    {
        ...
        try
        {
            ...
            _pongGameManager.SetIsMulpiplayerGame();
            PongGameMultipayer.Instance.StartClientGame();    
        }
        catch(LobbyServiceException e)
        {
            Debug.Log(e);
